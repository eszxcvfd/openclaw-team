import { Ai as sendTypingTelegram, Bi as parseTelegramTarget, Ea as createTopLevelChannelReplyToModeResolver, Fi as normalizeTelegramMessagingTarget, Hi as listTelegramDirectoryPeersFromConfig, Ii as resolveTelegramGroupRequireMention, Jp as buildExecApprovalPendingReplyPayload, Li as resolveTelegramGroupToolPolicy, Mi as parseTelegramReplyToMessageId, Ni as parseTelegramThreadId, Pi as looksLikeTelegramTargetId, Qp as resolveExecApprovalCommandDisplay, Ri as isTelegramExecApprovalClientEnabled, Si as sendTelegramPayloadMessages, Ui as buildTelegramGroupPeerId, Vi as listTelegramDirectoryGroupsFromConfig, ap as resolveOutboundSendDep, br as buildTelegramExecApprovalButtons, cr as probeTelegram, gi as collectTelegramStatusIssues, lm as parseTelegramTopicConversation, lr as monitorTelegramProvider, sf as listTelegramAccountIds, uf as resolveTelegramAccount, zi as resolveTelegramExecApprovalTarget } from "./auth-profiles-CmO7TMIb.js";
...
import { l as normalizeMessageChannel } from "./message-channel-BJH5Ixzm.js";
import { u as PAIRING_APPROVED_MESSAGE } from "./group-keys-CvPi-x-K.js";
import { a as resolveConfiguredFromCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-DRbc14bL.js";
import { o as buildTokenChannelStatusSummary } from "./status-helpers-D8YQ830F.js";
import { o as createScopedDmSecurityResolver } from "./channel-config-helpers-DEviHTY4.js";
...
import { a as createTextPairingAdapter, i as createPairingPrefixStripper } from "./channel-pairing-figwGsxT.js";
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-CmXuF1IV.js";
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-BcpHUrr9.js";
import { t as createPluginRuntimeStore } from "./runtime-store-CfVg5W_s.js";
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-DpFqWF3E.js";
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-Dv6u8wYP.js";
	...
	lifecycle: {
		onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
			if (resolveTelegramAccount({
				...
				const { deleteTelegramUpdateOffset } = await import("./update-offset-store-BlFSWHbw.js");
