...
import { t as danger } from "./globals-Ca-8xJiD.js";
...
import { D as loadConfig, Gc as resolveCommandSecretRefsViaGateway, I as writeConfigFile, Mt as listChannelPluginCatalogEntries, Uc as resolveMessageChannelSelection, Xl as resolveMessageActionDiscoveryForPlugin, Yl as createMessageActionDiscoveryContext, go as formatUsageReportLines, ho as loadProviderUsageSummary, j as readConfigFileSnapshot, nr as withProgress, pu as callGateway, wf as loadAuthProfileStore } from "./auth-profiles-CmO7TMIb.js";
...
import { o as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-BJH_nidM.js";
import { t as formatCliCommand } from "./command-format-CCj3DEbG.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-BMDcpmwL.js";
...
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DRbc14bL.js";
import "./zod-schema.agent-runtime-cWX_tx9u.js";
import "./shared-BAbGaRi2.js";
import "./status-helpers-D8YQ830F.js";
import { o as formatTimeAgo } from "./account-summary-CtZtXQQb.js";
import "./allow-from-DjJFBgUq.js";
import "./runtime-B5E7_GSf.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./registry-dNL0jg8o.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DVV_Bjz5.js";
...
import "./issue-format-DQV5hVk7.js";
...
import { t as createClackPrompter } from "./clack-prompter-mZGPU18F.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-zSjVCuaM.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-CB2NlePR.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-CEB6QJfJ.js";
import { t as parseLogLine } from "./parse-log-line-CGm0ryDc.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-BDRx0KaR.js";
import { a as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-B5sYWD29.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-ybU3m_RT.js"), import("./onboard-channels-nkAMFgS3.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-VUJ6dp5t.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-VUJ6dp5t.js");
			const prompter = createClackPrompter();
