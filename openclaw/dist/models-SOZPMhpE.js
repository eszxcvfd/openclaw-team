...
import { S as shortenHomePath } from "./utils-DzdaH7JM.js";
import { f as resolveAuthStorePathForDisplay, g as isWSLEnv, x as resolveOpenClawAgentDir } from "./models-config.providers.discovery-CdeTbmVZ.js";
import { $C as shouldEnableShellEnvFallback, Af as applyAuthProfileConfig, BS as isNonSecretApiKeyMarker, CS as hasUsableCustomProviderApiKey, Cf as ensureAuthProfileStore, D as loadConfig, DS as resolveEnvApiKey, Dv as resolveSecretRefString, ES as resolveAwsSdkEnvVarName, Gc as resolveCommandSecretRefsViaGateway, Gh as discoverModels, Gn as DEFAULT_OAUTH_WARN_MS, Jc as describeFailoverError, Kh as shouldSuppressBuiltInModel, Kn as buildAuthHealthSummary, M as readConfigFileSnapshotForWrite, P as setRuntimeConfigSnapshot, QC as getShellEnvAppliedKeys, TS as resolveApiKeyForProvider, Tf as loadAuthProfileStoreForRuntime, Vh as resolveModelWithRegistry, Wh as discoverAuthStorage, Wn as maskApiKey, _f as listProfilesForProvider, bf as upsertAuthProfile, d as resolveProfileUnusableUntilForDisplay, ho as loadProviderUsageSummary, i as clearAuthProfileCooldown, kS as resolveUsableCustomProviderApiKey, n as resolveAuthProfileOrder, qn as formatRemainingShort, ra as runEmbeddedPiAgent, rr as withProgressTotals, t as resolveAuthProfileEligibility, tw as resolveAuthProfileDisplayLabel, vo as formatUsageWindowSummary, vt as loadModelCatalog, w as createConfigIO, wt as resolvePluginProviders, xS as getCustomProviderApiKey, yf as setAuthProfileOrder } from "./auth-profiles-CmO7TMIb.js";
import { C as findNormalizedProviderValue, _ as resolveModelRefFromString, c as modelKey, d as parseModelRef, h as resolveDefaultModelForAgent, m as resolveConfiguredModelRef, r as buildModelAliasIndex, w as normalizeProviderId } from "./model-selection-BXQGwwqy.js";
import { n as resolveAgentModelPrimaryValue, r as toAgentModelListLike, t as resolveAgentModelFallbackValues } from "./model-input-Du2o9y_O.js";
import { r as normalizeStringEntries } from "./string-normalization-CnYrQB31.js";
import { g as resolveDefaultAgentWorkspaceDir } from "./workspace-OTiuBtkV.js";
import { a as resolveAgentDir, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir, s as resolveAgentExplicitModelPrimary, u as resolveAgentModelFallbacksOverride } from "./agent-scope-VMfvxKRt.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-eEZJg44K.js";
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-CV05Fs_3.js";
import { t as formatCliCommand } from "./command-format-CCj3DEbG.js";
import { t as parseDurationMs } from "./parse-duration-Dk3mjEvc.js";
import { A as resolveSessionTranscriptPath, N as resolveSessionTranscriptsDirForAgent } from "./query-expansion-l1du3GNx.js";
import { i as getModelsCommandSecretTargetIds } from "./command-secret-targets-DVV_Bjz5.js";
import { m as resolveUsageProviderId } from "./provider-usage-2SFkzVkv.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-Z78OT_bc.js";
import { d as openUrl } from "./onboard-helpers-S2DlfH3Y.js";
...
import { n as redactSecrets } from "./format-DtO9F4J3.js";
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, p as upsertCanonicalModelConfigEntry, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-D-GlcVL8.js";
import { n as logConfigUpdated } from "./logging-C48S-sDm.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-Dp-_xNrp.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-BWetN0S2.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-DyN2gOhR.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-6V8SerzR.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-DM_6HKBz.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-DnsNgivD.js");
