...
function buildNodeServiceEnvironment(params) {
	...
	const sharedEnv = resolveSharedServiceEnvironmentFields(env, params.platform ?? process.platform, extraPathDirs);
...
function resolveSharedServiceEnvironmentFields(env, platform, extraPathDirs) {
