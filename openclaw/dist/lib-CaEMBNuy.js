import { o as __toESM, r as __commonJSMin, t as require_src } from "./src-CmXHIz5f.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-Be7JvuPn.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-BLTRXCvX.js";
import { l as toRatio, n as decodeString } from "./Util-CFu2JVRY.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-B1VteCD5.js";
import { t as APEv2Parser } from "./APEv2Parser-hcuD5goF.js";
import { r as hasID3v1Header } from "./ID3v1Parser-C11_xM9T.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-wLoFZ5XA.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-CpdSApJ1.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-BAXHrrqy.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DK4ieafg.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-xKFOYZo1.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-Co1hrxZo.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CgzS_ymO.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CHb-Prra.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DMm7q9BV.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CyuAHI65.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-C-4NXqPh.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DrnTz8XC.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BXmK0wLz.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-585iVXBg.js")).WaveParser;
	}
};
//#endregion
