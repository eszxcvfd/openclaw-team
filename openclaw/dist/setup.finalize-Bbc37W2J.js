...
import { h as restoreTerminalState } from "./subsystem-YgTuVQVh.js";
import "./ansi-cwY8Vrne.js";
import "./boolean-B6zcAynR.js";
import "./env-CQLG1scp.js";
import "./warning-filter-hHA7Rorp.js";
import { h as pathExists, y as resolveUserPath } from "./utils-DzdaH7JM.js";
import "./links-g7g5mVf0.js";
import "./models-config.providers.discovery-CdeTbmVZ.js";
import { Za as listConfiguredWebSearchProviders } from "./auth-profiles-CmO7TMIb.js";
...
import { r as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-OTiuBtkV.js";
...
import { b as waitForGatewayReachable, d as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, o as formatControlUiSshHint, p as probeGatewayReachable } from "./onboard-helpers-S2DlfH3Y.js";
...
import { i as isSystemdUserServiceAvailable } from "./systemd-DH0Ry2f0.js";
...
import { t as runTui } from "./tui-BeZnzpDi.js";
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-D79VlxIj.js");
	...
	if (webSearchProvider) {
		const { resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DA5g9Bsa.js");
		...
		const { hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DA5g9Bsa.js");
