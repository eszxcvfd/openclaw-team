...
function loadManagerRuntime() {
	managerRuntimePromise ??= import("./manager-runtime-4NLK1HPm.js");
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-CtaJsbTq.js");
...
//#endregion
export { splitShellArgs as i, getMemorySearchManager as n, resolveMemoryBackendConfig as r, closeAllMemorySearchManagers as t };
