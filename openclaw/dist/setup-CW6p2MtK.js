...
import { I as writeConfigFile, ci as formatPluginCompatibilityNotice, ii as buildPluginCompatibilityNotices, j as readConfigFileSnapshot } from "./auth-profiles-CmO7TMIb.js";
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-B_nfU8gL.js");
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-BNcrpTbs.js");
		const { logConfigUpdated } = await import("./logging-D18DqntI.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-CrUK4KJ0.js");
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-Cj-3O4Xx.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-DXyfV-0p.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-LljSceSW.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-0aK0zOIa.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-CJ78i8MB.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-B94TttPl.js");
		const { setupChannels } = await import("./onboard-channels-nkAMFgS3.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-DA5g9Bsa.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-DnsKd91-.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-BPjk0kZL.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-Bbc37W2J.js");
