...
import { _ as resolveHomeDir, d as isRecord } from "./utils-DzdaH7JM.js";
import { V as OpenClawSchema, j as readConfigFileSnapshot } from "./auth-profiles-CmO7TMIb.js";
import { n as formatConfigIssueLines } from "./issue-format-DQV5hVk7.js";
import { t as note } from "./note-BSDRigBf.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-DcE25m3p.js");
