...
import { m as resolveDefaultAgentId } from "./agent-scope-VMfvxKRt.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-CV05Fs_3.js";
import { i as normalizePluginsConfig, l as extensionUsesSkippedScannerPath, u as isPathInside } from "./config-state-1aMcm4RG.js";
import { A as formatPermissionRemediation, I as resolveSandboxConfigForAgent, J as resolveToolProfilePolicy, M as safeStat, at as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, i as listAgentWorkspaceDirs, j as inspectPathPermissions, k as formatPermissionDetail, l as execDockerRaw, r as pickSandboxToolPolicy, t as isToolAllowedByPolicies, z as resolveSandboxToolPolicyForAgent } from "./tool-policy-match-BxOSaweu.js";
import { t as formatCliCommand } from "./command-format-CCj3DEbG.js";
import { a as resolveNativeSkillsEnabled } from "./commands--uIhX2I_.js";
import { n as MANIFEST_KEY } from "./legacy-names-DeRhPpHL.js";
import { t as scanDirectoryWithSummary } from "./skill-scanner-CmNfHxVY.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-DHGI2e7X.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./skills-RLnK1248.js");
	return skillsModulePromise;
}
function loadConfigModule() {
	configModulePromise ??= import("./config-CAIQW9wT.js");
