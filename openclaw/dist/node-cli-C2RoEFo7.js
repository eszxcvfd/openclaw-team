...
import { AC as normalizeExecutableToken, A_ as redactCdpUrl, Ap as resolveExecApprovals, D as loadConfig, DC as resolveCommandResolutionFromArgv, Dp as recordAllowlistUse, Ep as readExecApprovalsSnapshot, Fp as evaluateExecAllowlist, Ip as evaluateShellAllowlist, MC as unwrapKnownShellMultiplexerInvocation, M_ as createBrowserRouteDispatcher, NC as POSIX_INLINE_COMMAND_FLAGS, N_ as createBrowserControlContext, Nu as resolveExecSafeBinRuntimePolicy, OC as resolveExecutableFromPathEnv, PC as resolveInlineCommandMatch, P_ as startBrowserControlServiceFromConfig, Pp as saveExecApprovals, Sp as normalizeExecApprovals, Sr as resolveGatewayConnectionAuth, Ud as getMachineDisplayName, Vp as requestJsonlSocket, _a as withTimeout, _p as ensureExecApprovals, bp as mergeExecApprovalsSocketDefaults, gp as addAllowlistEntry, ir as formatHelpExamples, iu as resolveSystemRunCommandRequest, jC as unwrapKnownDispatchWrapperInvocation, ju as isInterpreterLikeSafeBin, kC as POSIX_SHELL_WRAPPERS, kp as requiresExecApproval, lu as normalizeSystemRunApprovalPlan, pC as analyzeArgvCommand, ru as formatExecCommand, yC as resolvePlannedSegmentArgv, zp as resolveAllowAlwaysPatterns } from "./auth-profiles-CmO7TMIb.js";
import "./model-selection-BXQGwwqy.js";
import "./boundary-path-BVHzCDEE.js";
import { t as sameFileIdentity } from "./file-identity-BuWjK4Mb.js";
import "./boundary-file-read-1knRHcS0.js";
import { a as logWarn } from "./logger-CSnzpOlU.js";
import "./exec-vhyLuPtA.js";
import "./workspace-OTiuBtkV.js";
import { i as resolveAgentConfig } from "./agent-scope-VMfvxKRt.js";
import { C as sanitizeSystemRunEnvOverrides, _ as inspectHostExecEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-Ck_KN5Yc.js";
import "./safe-text-BRtokf22.js";
import { n as VERSION } from "./version-GCXYdDuZ.js";
import { n as resolveBrowserConfig } from "./config-VwKeuZ6Q.js";
import "./config-state-1aMcm4RG.js";
import "./tool-policy-match-BxOSaweu.js";
import "./provider-web-search-65U3wtCD.js";
import { i as splitShellArgs } from "./search-manager-DN27lb4F.js";
...
import { t as detectMime } from "./mime-Dp6jja6u.js";
...
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-BJH5Ixzm.js";
...
import { cn as loadOrCreateDeviceIdentity, u as GatewayClient } from "./method-scopes-CThAM_Qd.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-CfO0kRfN.js";
...
import { a as resolveNodeProgramArguments, n as resolveDaemonInstallRuntimeInputs, r as resolveDaemonNodeBinDir, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-CrdSJTU_.js";
import { c as buildNodeServiceEnvironment } from "./runtime-paths-C7cN1yo9.js";
import "./runtime-guard-BiaA8gCk.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-ixFVG0Ja.js";
import "./runtime-parse-Cup9YTIZ.js";
import "./launchd-BYsO-Ud6.js";
import "./service-BH8cQwiC.js";
import "./systemd-DH0Ry2f0.js";
import { f as buildDaemonServiceSnapshot, h as installDaemonServiceAndEmit, n as createDaemonInstallActionContext, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles, u as resolveRuntimeStatusColor } from "./shared-Bf6Usy-_.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-DCnfdnYC.js";
import { t as parsePort } from "./parse-port-WTPxHtX4.js";
import "./issue-format-DQV5hVk7.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-qvEnlLoy.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-CdY4ISxr.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands-yGwvGkQV.js";
import { t as resolveNodeService } from "./node-service-DhpvZtAy.js";
