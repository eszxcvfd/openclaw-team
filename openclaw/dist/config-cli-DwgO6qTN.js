...
import { n as info, t as danger, u as success } from "./globals-Ca-8xJiD.js";
...
import { I as writeConfigFile, Ov as resolveSecretRefValue, R as validateConfigObjectRaw, j as readConfigFileSnapshot } from "./auth-profiles-CmO7TMIb.js";
...
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-CV05Fs_3.js";
...
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-y2XJTbie.js";
...
import { h as resolveConfigSecretTargetByPath, u as discoverConfigSecretTargets } from "./command-secret-targets-DVV_Bjz5.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-DQV5hVk7.js";
import { t as redactConfigObject } from "./redact-snapshot-BKlxDvmD.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-DEJlAULo.js");
