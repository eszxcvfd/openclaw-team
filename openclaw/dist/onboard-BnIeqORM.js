...
import { h as restoreTerminalState, m as defaultRuntime } from "./subsystem-YgTuVQVh.js";
import { y as resolveUserPath } from "./utils-DzdaH7JM.js";
import { I as writeConfigFile, j as readConfigFileSnapshot } from "./auth-profiles-CmO7TMIb.js";
import { s as isValidEnvSecretRefId } from "./types.secrets-CV05Fs_3.js";
...
import "./daemon-runtime-ixFVG0Ja.js";
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-S2DlfH3Y.js";
import { t as WizardCancelledError } from "./prompts-zuGrlkFK.js";
import { t as createClackPrompter } from "./clack-prompter-mZGPU18F.js";
import { t as runSetupWizard } from "./setup-CW6p2MtK.js";
import { n as logConfigUpdated } from "./logging-C48S-sDm.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-BWSFODpl.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-RmPen4AJ.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-dKtANcU5.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-CV_floA6.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C9sIDEWU.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-J8XfBfsm.js");
