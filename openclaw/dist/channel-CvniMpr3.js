import { Ta as createStaticReplyToModeResolver } from "./auth-profiles-CmO7TMIb.js";
import { t as DEFAULT_ACCOUNT_ID } from "./account-id-BBUVs4qN.js";
import { f as GroupPolicySchema, l as DmPolicySchema, n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema, v as MarkdownConfigSchema } from "./config-schema-DjM6jQY2.js";
...
import { p as readStringParam, s as jsonResult } from "./common-G_FV6fHD.js";
import { r as buildSecretInputSchema } from "./secret-input-Ua-MPZgk.js";
import { o as buildTokenChannelStatusSummary, t as buildBaseAccountStatusSnapshot } from "./status-helpers-D8YQ830F.js";
import { t as formatAllowFromLowercase } from "./allow-from-DjJFBgUq.js";
import { l as isNumericTargetId, y as sendPayloadWithChunkedTextAndMedia } from "./reply-payload-DnYXGJnk.js";
import { d as mapAllowFromEntries, i as createScopedChannelConfigAdapter, o as createScopedDmSecurityResolver } from "./channel-config-helpers-DEviHTY4.js";
import { n as buildOpenGroupPolicyRestrictSendersWarning, r as buildOpenGroupPolicyWarning, v as createOpenProviderGroupPolicyWarningCollector } from "./group-policy-warnings-BOCcn5UQ.js";
import { d as listResolvedDirectoryUserEntriesFromAllowFrom, p as createChannelDirectoryAdapter } from "./directory-runtime-DjKjbEt4.js";
import { i as createLazyRuntimeNamedExport, r as createLazyRuntimeModule } from "./lazy-runtime-CKdxDBg0.js";
import { a as createEmptyChannelResult, o as createRawChannelSendResultAdapter } from "./channel-send-result-CmXuF1IV.js";
import { t as extractToolSend } from "./tool-send-Pjovf7rE.js";
import { i as coerceStatusIssueAccountId, o as readStatusIssueFields } from "./extension-shared-CJEjBziQ.js";
import { n as zaloSetupWizard, r as zaloSetupAdapter } from "./zalo-D84OUp-N.js";
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-BQ9DcFzW.js";
import { t as chunkTextForOutbound } from "./text-chunking-3lfMUttn.js";
import { z } from "zod";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-BwPt20Dt.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-DzN9527b.js"));
