...
import { C as sleep } from "./utils-DzdaH7JM.js";
import { t as normalizeOptionalSecretInput } from "./normalize-secret-input-BZufH2HR.js";
import { a as KILOCODE_DEFAULT_MODEL_ID, c as KILOCODE_MODEL_CATALOG, i as KILOCODE_DEFAULT_MAX_TOKENS, n as KILOCODE_DEFAULT_CONTEXT_WINDOW, o as KILOCODE_DEFAULT_MODEL_NAME, r as KILOCODE_DEFAULT_COST, t as KILOCODE_BASE_URL } from "./kilocode-shared-piT8G4er.js";
...
//#endregion
export { isReasoningModelHeuristic as $, TOGETHER_MODEL_CATALOG as A, buildChutesModelDefinition as B, VENICE_DEFAULT_MODEL_REF as C, resolveAnthropicVertexProjectId as Ct, resolveRetryConfig as D, discoverVeniceModels as E, buildSyntheticModelDefinition as F, buildHuggingfaceModelDefinition as G, discoverKilocodeModels as H, CHUTES_BASE_URL as I, OLLAMA_DEFAULT_COST as J, discoverHuggingfaceModels as K, CHUTES_DEFAULT_MODEL_ID as L, SYNTHETIC_BASE_URL as M, SYNTHETIC_DEFAULT_MODEL_REF as N, retryAsync as O, SYNTHETIC_MODEL_CATALOG as P, fetchOllamaModels as Q, CHUTES_DEFAULT_MODEL_REF as R, VENICE_BASE_URL as S, resolveAnthropicVertexClientRegion as St, buildVeniceModelDefinition as T, HUGGINGFACE_BASE_URL as U, discoverChutesModels as V, HUGGINGFACE_MODEL_CATALOG as W, buildOllamaModelDefinition as X, OLLAMA_DEFAULT_MAX_TOKENS as Y, enrichOllamaModelsWithContext as Z, BYTEPLUS_BASE_URL as _, hasNativeWebSearchTool as _t, SGLANG_DEFAULT_BASE_URL as a, OPENCODE_ZEN_DEFAULT_MODEL_REF as at, BYTEPLUS_MODEL_CATALOG as b, usesXaiToolSchemaProfile as bt, VLLM_DEFAULT_API_KEY_ENV_VAR as c, OPENCODE_GO_DEFAULT_MODEL_REF as ct, VLLM_PROVIDER_LABEL as d, applyOpenAIConfig as dt, resolveOllamaApiBase as et, DOUBAO_BASE_URL as f, applyPrimaryModel as ft, buildDoubaoModelDefinition as g, applyXaiModelCompat as gt, DOUBAO_MODEL_CATALOG as h, XAI_TOOL_SCHEMA_PROFILE as ht, SGLANG_DEFAULT_API_KEY_ENV_VAR as i, resolveCloudflareAiGatewayBaseUrl as it, buildTogetherModelDefinition as j, TOGETHER_BASE_URL as k, VLLM_DEFAULT_BASE_URL as l, OPENCODE_ZEN_DEFAULT_MODEL$1 as lt, DOUBAO_CODING_MODEL_CATALOG as m, HTML_ENTITY_TOOL_CALL_ARGUMENTS_ENCODING as mt, VERCEL_AI_GATEWAY_BASE_URL as n, CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF as nt, SGLANG_MODEL_PLACEHOLDER as o, GOOGLE_GEMINI_DEFAULT_MODEL as ot, DOUBAO_CODING_BASE_URL as p, cloneFirstTemplateModel as pt, OLLAMA_DEFAULT_CONTEXT_WINDOW as q, discoverVercelAiGatewayModels as r, buildCloudflareAiGatewayModelDefinition as rt, SGLANG_PROVIDER_LABEL as s, OPENAI_DEFAULT_MODEL as st, buildKilocodeModelDefinition as t, OLLAMA_DEFAULT_BASE_URL as tt, VLLM_MODEL_PLACEHOLDER as u, applyGoogleGeminiModelDefault as ut, BYTEPLUS_CODING_BASE_URL as v, normalizeModelCompat as vt, VENICE_MODEL_CATALOG as w, resolveAnthropicVertexRegion as wt, buildBytePlusModelDefinition as x, hasAnthropicVertexAvailableAuth as xt, BYTEPLUS_CODING_MODEL_CATALOG as y, resolveToolCallArgumentsEncoding as yt, CHUTES_MODEL_CATALOG as z };
