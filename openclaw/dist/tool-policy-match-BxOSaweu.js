...
import { m as defaultRuntime, t as createSubsystemLogger } from "./subsystem-YgTuVQVh.js";
import { n as markOpenClawExecEnv } from "./openclaw-exec-env-DQumaYka.js";
import { D as isPlainObject, y as resolveUserPath } from "./utils-DzdaH7JM.js";
import { c as normalizeAgentId, u as resolveAgentIdFromSessionKey } from "./session-key-CPq9Fbcf.js";
import { t as isBlockedObjectKey } from "./prototype-keys-mkcCRiyK.js";
import { i as resolvePathViaExistingAncestorSync } from "./boundary-path-BVHzCDEE.js";
import { r as openBoundaryFileSync, t as canUseBoundaryFileOpen } from "./boundary-file-read-1knRHcS0.js";
import { r as runExec } from "./exec-vhyLuPtA.js";
import { i as resolveAgentConfig, m as resolveDefaultAgentId, p as resolveAgentWorkspaceDir } from "./agent-scope-VMfvxKRt.js";
import { l as normalizeSecretInputString } from "./types.secrets-CV05Fs_3.js";
import { u as isPathInside } from "./config-state-1aMcm4RG.js";
import { c as CHANNEL_IDS } from "./registry-COOqBSUM.js";
import { t as formatCliCommand } from "./command-format-CCj3DEbG.js";
import { t as getBlockedNetworkModeReason } from "./network-mode-CiBnyCg3.js";
import { n as getProcessStartTime, r as isPidAlive, t as resolveProcessScopedMap } from "./process-scoped-map-WSZeQc19.js";
import { r as writeJsonAtomic } from "./json-files-CW7rEs_Q.js";
import { t as sanitizeEnvVars } from "./sanitize-env-vars-FWt27Jbr.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-BIUIIY11.js";
...
//#endregion
export { compileGlobPatterns as $, formatPermissionRemediation as A, applyOwnerOnlyToolPolicy as B, readRegistry as C, updateRegistry as D, updateBrowserRegistry as E, resolveSandboxBrowserDockerCreateConfig as F, stripPluginOnlyAllowlist as G, collectExplicitAllowlist as H, resolveSandboxConfigForAgent as I, resolveToolProfilePolicy as J, expandToolGroups as K, resolveSandboxScope as L, safeStat as M, createIcaclsResetCommand as N, computeSandboxBrowserConfigHash as O, formatIcaclsResetCommand as P, resolveCoreToolProfiles as Q, isToolAllowed as R, readBrowserRegistry as S, removeRegistryEntry as T, expandPolicyWithPluginGroups as U, buildPluginToolGroups as V, mergeAlsoAllowPolicy as W, isKnownCoreToolId as X, PROFILE_OPTIONS as Y, listCoreToolSections as Z, splitSandboxBindSpec as _, buildSandboxCreateArgs as a, SANDBOX_BROWSER_SECURITY_HASH_EPOCH as at, resolveSandboxWorkspaceDir as b, execDocker as c, resolveSessionLockMaxHoldFromTimeout as ct, readDockerContainerLabel as d, INCLUDE_KEY as dt, matchesAnyGlobPattern as et, readDockerPort as f, readConfigIncludeFileWithGuards as ft, resolveSandboxHostPathViaExistingAncestor as g, validateNetworkMode as h, listAgentWorkspaceDirs as i, SANDBOX_AGENT_WORKSPACE_MOUNT as it, inspectPathPermissions as j, formatPermissionDetail as k, execDockerRaw as l, CircularIncludeError as lt, getBlockedBindReason as m, isToolAllowedByPolicyName as n, DEFAULT_SANDBOX_COMMON_IMAGE as nt, dockerContainerState as o, acquireSessionWriteLock as ot, appendWorkspaceMountArgs as p, resolveConfigIncludes as pt, normalizeToolName as q, pickSandboxToolPolicy as r, DEFAULT_SANDBOX_IMAGE as rt, ensureSandboxContainer as s, cleanStaleLockFiles as st, isToolAllowedByPolicies as t, DEFAULT_SANDBOX_BROWSER_IMAGE as tt, readDockerContainerEnvVar as u, ConfigIncludeError as ut, resolveSandboxAgentId as v, removeBrowserRegistryEntry as w, slugifySessionKey as x, resolveSandboxScopeKey as y, resolveSandboxToolPolicyForAgent as z };
