...
import { A_ as redactCdpUrl, Mu as listInterpreterLikeSafeBins, Nt as hasPotentialConfiguredChannels, Pu as resolveMergedSafeBinProfileFixtures, fC as normalizeTrustedSafeBinDirs, yv as resolveBrowserControlAuth } from "./auth-profiles-CmO7TMIb.js";
import { a as hasConfiguredSecretInput } from "./types.secrets-CV05Fs_3.js";
import { m as resolveGatewayAuth, n as resolveBrowserConfig, r as resolveProfile } from "./config-VwKeuZ6Q.js";
import { A as formatPermissionRemediation, I as resolveSandboxConfigForAgent, j as inspectPathPermissions, k as formatPermissionDetail } from "./tool-policy-match-BxOSaweu.js";
import { t as formatCliCommand } from "./command-format-CCj3DEbG.js";
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-BZ_EPMmt.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-BTz8xJbZ.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BTRGUB0z.js";
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-B94TttPl.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BurzGMwJ.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-DJKiKRv7.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-MrV2UtTR.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-BNF0Pr5v.js"),
		import("./probe-auth-DOaLJc7H.js"),
		import("./probe-CQBWlyfh.js")
