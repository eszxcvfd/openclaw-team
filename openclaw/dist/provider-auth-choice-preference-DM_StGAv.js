import { x as resolveOpenClawAgentDir } from "./models-config.providers.discovery-CdeTbmVZ.js";
import { Af as applyAuthProfileConfig, Bf as normalizeTokenProviderInput, Cf as ensureAuthProfileStore, Ff as ensureApiKeyFromOptionEnvOrPrompt, Rf as normalizeApiKeyInput, Uf as validateApiKeyInput, bf as upsertAuthProfile, jf as buildApiKeyCredential, n as resolveAuthProfileOrder, zf as normalizeSecretInputModeInput } from "./auth-profiles-CmO7TMIb.js";
import { r as applyProviderConfigWithDefaultModel, t as applyAgentDefaultModelPrimary } from "./provider-onboarding-config-DhLPH58N.js";
import { n as resolveManifestProviderAuthChoice, t as resolveManifestProviderApiKeyChoice } from "./provider-auth-choices-BWSFODpl.js";
import { t as createAuthChoiceDefaultModelApplierForMutableState } from "./auth-choice.apply-helpers-Bo2KrSz6.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-BhfZvf8S.js");
