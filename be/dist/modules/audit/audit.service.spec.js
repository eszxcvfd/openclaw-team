...
describe('AuditService', () => {
    ...
    it('rejects oversized pageSize', async () => {
        await expect(service.listAuditLogs({ pageSize: 101 })).rejects.toThrow(common_1.BadRequestException);
    });
    ...
    it('throws not found for unknown detail id', async () => {
        ...
        await expect(service.getAuditLogDetail('unknown-log')).rejects.toThrow(common_1.NotFoundException);
    });
