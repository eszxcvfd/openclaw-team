...
describe('ToolCallLoggerService', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await testing_1.Test.createTestingModule({
            providers: [
                ...
                {
                    provide: tool_call_log_metadata_resolver_1.ToolCallLogMetadataResolver,
                    useValue: metadataResolver,
                },
            ],
        }).compile();
        service = module.get(tool_call_logger_service_1.ToolCallLoggerService);
    });
    ...
    it('swallows metadata resolution failures so audit cannot change request behavior', async () => {
        ...
        await expect(service.logExecutionResult({
            request: {
                method: 'GET',
                headers: {
...
//# sourceMappingURL=tool-call-logger.service.spec.js.map