...
describe('ConversationService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(conversation_service_1.ConversationService);
    });
    describe('getMessagesForUser', () => {
        it('should only return messages from a conversation owned by the user', async () => {
            ...
            await expect(service.getMessagesForUser('user-1', 'conv-1')).resolves.toEqual([
                {
                    id: 'msg-1',
                    sender_type: 'user',
                    content: 'Hello',
        ...
        it('should throw when the conversation is not owned by the user', async () => {
            ...
            await expect(service.getMessagesForUser('user-1', 'conv-2')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('saveMessage', () => {
        it('should persist arbitrary metadata for later history rehydration', async () => {
            ...
            await service.saveMessage('conv-1', 'assistant', 'Quiz ready', undefined, {
                uiPayloadVersion: 1,
